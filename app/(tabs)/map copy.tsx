...
import { View, StyleSheet, Text, SafeAreaView, Dimensions, Pressable, Platform} from 'react-native';
        ...
        <View style={styles.container}>
            ...
            >
                {places.map((loc) => (
                    ...
                    >
                        {/*<View style={[{height:20, width:20, backgroundColor:'green'}, Platform.OS === 'ios' ? {height: 75, width: 60, top: -37} : {}]}>
                        </View>
                        <AnimatedMarker
                            loc={loc}
