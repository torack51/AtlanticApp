...
import { atlanticupGetPlaceFromId, atlanticupUpdateMatchStatus, atlanticupGetTeamFromId } from '../../backend/atlanticupBackendFunctions';
...
const Type3Match: React.FC<Props> = ({match}) => {
